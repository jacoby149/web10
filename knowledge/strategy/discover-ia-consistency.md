...
**Status: SHIPPED (3.157.0).** Operator sign-off on the three flagged decisions was GIVEN (23.09.2026). The operator's pass (23.09.2026,
...
- [✓ 3.157.0] **A1: `Posts` → `Trending`, `People` → `Profiles` (the tab row).**
...
- [✓ 3.157.0] **A2: the People section icon = two-overlapped; confirm the Profiles tab =
...
- [✓ 3.157.0] **A3: side padding on the Discover screen.** The operator: "no padding at
...
- [✓ 3.157.0] **B1: the keys mark only (no wordmark) in the sidebar.** `Layout.tsx`
...
- [✓ 3.157.0] **B2: the search field moves from the top bar to the sidebar (desktop).**
...
- [✓ 3.157.0] **B3: the Trending | Profiles tabs move into the top bar (desktop,
...
- [✓ 3.157.0] **C1: extract the People + Groups cards into `@web10/discover` (the
...
- [✓ 3.157.0] **C2: the marketing nav — `Trending` → `Discover`; drop `Groups`.**
...
- [✓ 3.157.0] **C3: the marketing Discover page = the social Discover (Trending |
...
- [✓ 3.157.0] **C4: marketing card parity (the "super old" groups render is gone).**
...
- [✓ 3.157.0] **D1: keep the KB true.** `discover-reorg.md` (the tabs are now
