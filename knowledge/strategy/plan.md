...
- [ ] **Follow-up: group permalink** — the same preview-server pattern for `/groups/:id` (the group's face — cover + avatar from the `web10-social-group-identity` doc, D60 — as the image). A new route in the same social preview server.
