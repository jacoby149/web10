...
- [✓ 3.7.0] Create/join discover group (open, auto-join)
- [✓ 3.7.0] Post to discover group
- [✓ 3.7.0] Create followers groups for 2-3 test users
- [✓ 3.7.0] Follow creators (join followers groups)
- [✓ 3.7.0] Read combined feed from discover + followers
- [✓ 3.7.0] E2E test: post → follow → read combined feed
