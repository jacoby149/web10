...
- [✓ 3.6.0] WebRTC: initP2P with token, connect to peer
- [✓ 3.6.0] WebRTC: send data over P2P channel
- [✓ 3.6.0] WebRTC: receive data via onInbound callback
- [✓ 3.6.0] E2E test: DM CRUD + WebRTC P2P round-trip (DM CRUD half done in 3.5.0; WebRTC P2P half done in 3.6.0)
