...
- [ ] UI: the directory screen (minimal grid, apps enrich + deep-linkable detail with "join to view"; topic search by filtering the directory's tags client-side)
