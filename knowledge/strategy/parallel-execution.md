...
- [ ] **Follow-up** — group permalink (same endpoint pattern: the group's face — cover + avatar from the `web10-social-group-identity` doc, D60 — as the image). The post + profile permalinks ship first.
