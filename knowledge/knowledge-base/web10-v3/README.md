...
│   ├── group-chat.md      ← N-person messaging in the Messages surface: a group with kind:'chat' on its face, a name + members, per-sender bubbles (CRUD-only real-time in v1)
