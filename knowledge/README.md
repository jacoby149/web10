...
Butcher → Architect → Tuner → Translator. Cut first, then shape, then polish, then adapt.

## The Knowledge Base

[knowledge-base/](./knowledge-base/) is the actual content — architecture, protocol, security docs for web10. Everything above is how to produce it.