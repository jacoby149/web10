    ...
    <div style={{ width: "300px", marginBottom: "10px" }}>
      <div className="field">
        <p style={{ margin: "10px 10px" }} className="control has-icons-left">
          <input
            ...
            defaultValue={config.REACT_APP_DEFAULT_API
            }
      ...
      {loginMode ? (
        ...
        <div>
          ...
          <div style={config.REACT_APP_VERIFY_REQUIRED ? { margin: "0 10px" } : { display: "None" }}>
          ...
          <div style={config.REACT_APP_BETA_REQUIRED ? {} : { display: "None" }} className="field">
            <p
