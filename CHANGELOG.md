1.0.301 || 03.08.2026
docs: web10 v3 groups — policy containers, not data containers. Groups hold people, not posts. Two contract types: service contracts restrict (floor), group contracts grant (widen). Posts attach to groups to widen access. Groups carry across apps — one membership, infinite apps. Follows are groups. User panel has two views: service contracts and group contracts.
