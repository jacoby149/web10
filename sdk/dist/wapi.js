...
},{"../cancel/CanceledError":9,"../core/AxiosError":12,"../core/buildFullPath":14,"../defaults/transitional":20,"../helpers/parseProtocol":32,"./../core/settle":17,"./../helpers/buildURL":23,"./../helpers/cookies":25,"./../helpers/isURLSameOrigin":28,"./../helpers/parseHeaders":31,"./../utils":36}],7:[function(require,module,exports){
'use strict';
...
},{"../lib/core/AxiosError":12,"./cancel/CancelToken":8,"./cancel/CanceledError":9,"./cancel/isCancel":10,"./core/Axios":11,"./core/mergeConfig":16,"./defaults":19,"./env/data":21,"./helpers/bind":22,"./helpers/isAxiosError":27,"./helpers/spread":33,"./helpers/toFormData":34,"./utils":36}],8:[function(require,module,exports){
'use strict';
...
},{"./CanceledError":9}],9:[function(require,module,exports){
'use strict';
...
},{"../core/AxiosError":12,"../utils":36}],10:[function(require,module,exports){
'use strict';
...
},{"../helpers/buildURL":23,"../helpers/validator":35,"./../utils":36,"./InterceptorManager":13,"./buildFullPath":14,"./dispatchRequest":15,"./mergeConfig":16}],12:[function(require,module,exports){
'use strict';
...
},{"../utils":36}],13:[function(require,module,exports){
'use strict';
...
},{"../cancel/CanceledError":9,"../cancel/isCancel":10,"../defaults":19,"./../utils":36,"./transformData":18}],16:[function(require,module,exports){
'use strict';
...
},{"./AxiosError":12}],18:[function(require,module,exports){
'use strict';
...
},{"../defaults":19,"./../utils":36}],19:[function(require,module,exports){
...
},{"../adapters/http":6,"../adapters/xhr":6,"../core/AxiosError":12,"../helpers/normalizeHeaderName":29,"../helpers/toFormData":34,"../utils":36,"./env/FormData":30,"./transitional":20,"_process":4}],20:[function(require,module,exports){
'use strict';
...
},{"../utils":36,"buffer":2}],35:[function(require,module,exports){
'use strict';
...
},{"../core/AxiosError":12,"../env/data":21}],36:[function(require,module,exports){
'use strict';
...
},{"eventemitter3":37,"peerjs-js-binarypack":38,"webrtc-adapter":43}],41:[function(require,module,exports){
/*
...
},{"./chrome/chrome_shim":45,"./common_shim":48,"./edge/edge_shim":49,"./firefox/firefox_shim":53,"./safari/safari_shim":56,"./utils":57}],45:[function(require,module,exports){
/*
 *  Copyright (c) 2016 The WebRTC project authors. All Rights Reserved.
 *
 *  Use of this source code is governed by a BSD-style license
...
},{"../utils.js":57,"./getdisplaymedia":46,"./getusermedia":47}],46:[function(require,module,exports){
/*
...
},{"../utils.js":57}],48:[function(require,module,exports){
/*
 *  Copyright (c) 2017 The WebRTC project authors. All Rights Reserved.
 *
 *  Use of this source code is governed by a BSD-style license
...
},{"./utils":57,"sdp":42}],49:[function(require,module,exports){
/*
 *  Copyright (c) 2016 The WebRTC project authors. All Rights Reserved.
 *
 *  Use of this source code is governed by a BSD-style license
...
},{"../utils":57,"./filtericeservers":50,"./getdisplaymedia":51,"./getusermedia":52,"rtcpeerconnection-shim":41}],50:[function(require,module,exports){
/*
...
},{"../utils":57,"./getdisplaymedia":54,"./getusermedia":55}],54:[function(require,module,exports){
/*
 *  Copyright (c) 2018 The adapter.js project authors. All Rights Reserved.
 *
 *  Use of this source code is governed by a BSD-style license
...
Object.defineProperty(exports, "wapiAuthInit", {
  enumerable: true,
  get: function get() {
...
function cookieDict() {
  return window.document.cookie.split(";").reduce(function (res, c) {
    ...
    try {
      return Object.assign(res, _defineProperty({}, key, JSON.parse(val)));
    } catch (e) {
...
var wapiInit = function wapiInit() {
  ...
  wapi.setToken = function (token) {
    ...
    var age = 3600 * 24 * 60;
    document.cookie = "token=".concat(wapi.token, ";Secure;path=/;max-age=").concat(age, ";");
  };
  ...
  /**
    ...
    */
  wapi.aggregate = function (service) {
    ...
    return _axios["default"].post("".concat(protocol, "//").concat(provider, "/").concat(username, "/").concat(service, "/aggregate"), {
      token: wapi.token,
      pipeline: pipeline
    });
  };
  ...
  */
  wapi._W10CRUD = function (HTTPRequestFunction, provider, username, service, query, update, protocol) {
    ...
    provider = provider || wapi.readToken().provider;
    username = username || wapi.readToken().username;
    return HTTPRequestFunction("".concat(protocol, "//").concat(provider, "/").concat(username, "/").concat(service), {
      token: wapi.token,
      query: query,
      update: update
    });
...
},{"./wapiAuth":59,"axios":5,"peerjs":40}],59:[function(require,module,exports){
"use strict";
...
var wapiAuthInit = function wapiAuthInit(wapi) {
  ...
  wapiAuth.logIn = function (provider, username, password) {
    return _axios["default"].post("".concat(wapi.APIProtocol, "//").concat(provider, "/web10token"), {
      username: username,
      password: password,
      token: null,
  ...
  wapiAuth.signUp = function (provider, username, password, betacode, phone) {
    return _axios["default"].post("".concat(wapi.APIProtocol, "//").concat(provider, "/signup"), {
      username: username,
      password: password,
      betacode: betacode,
      phone: phone
  ...
  */
  var api = function api() {
    return "".concat(wapi.APIProtocol, "//").concat(wapi.readToken()["provider"]);
  };
  ...
  wapiAuth.changePass = function (pass, newPass) {
    return _axios["default"].post("".concat(api(), "/change_pass"), {
      username: wapi.readToken()["username"],
      password: pass,
      new_pass: newPass
    });
  ...
  wapiAuth.changePhone = function (pass, newPhone) {
    ...
    return _axios["default"].post("".concat(api(), "/change_phone"), {
      username: wapi.readToken()["username"],
      password: pass,
      phone: newPhone
    });
  ...
  wapiAuth.sendCode = function () {
    return _axios["default"].post("".concat(api(), "/send_code"), {
      token: wapi.token
    });
  };
  ...
  wapiAuth.verifyCode = function (code) {
    return _axios["default"].post("".concat(api(), "/verify_code"), {
      token: wapi.token,
      query: {
        code: code
      }
  ...
  wapiAuth.manageSpace = function () {
    return _axios["default"].post("".concat(api(), "/manage_space"), {
      token: wapi.token
    });
  };
  ...
  wapiAuth.manageCredits = function () {
    return _axios["default"].post("".concat(api(), "/manage_credits"), {
      token: wapi.token
    });
  };
  ...
  wapiAuth.manageBusiness = function () {
    return _axios["default"].post("".concat(api(), "/manage_business"), {
      token: wapi.token
    });
  };
  ...
  wapiAuth.manageSubscriptions = function () {
    return _axios["default"].post("".concat(api(), "/manage_subscriptions"), {
      token: wapi.token
    });
  };
  ...
  wapiAuth.businessLogin = function () {
    return _axios["default"].post("".concat(api(), "/business_login"), {
      token: wapi.token
    });
  };
  ...
  wapiAuth.getPlan = function () {
    return _axios["default"].post("".concat(api(), "/get_plan"), {
      token: wapi.token
    });
  };
